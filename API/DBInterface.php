...
class DBConnection {
    ...
    public function __construct() {
        ...
        $this->db = new PDO("mysql:host=" . self::DBServername, self::DBUsername, self::DBPassword);
    ...
    /**
     * Prepairs and executes a query on the database and returns a messege, 
